...
public:
...
#if KNEWSTUFFCORE_ENABLE_DEPRECATED_SINCE(6, 5)
    /**
     ...
     * @deprecated since 6.5, use installLatest or installLinkId instead
     */
    KNEWSTUFFCORE_DEPRECATED_VERSION(6, 5, "use installLatest or installLinkId instead")
