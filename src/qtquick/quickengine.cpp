...
#warning technically it'd be better if this was :public EngineBasePrivate so we don't have two dptrs
class EnginePrivate
{
public:
    bool isValid = false;
...
{
#warning do we even still need this code or could the function just do nothing
